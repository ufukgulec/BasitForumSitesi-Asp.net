<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="paylasimlar.aspx.cs" Inherits="platform.Paylasimlar.paylasimlar" %>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <div class="site-heading">
                        <h1>
                            <asp:Label ID="konuBaslik" runat="server" Text="Label"></asp:Label>
                        </h1>
                    </div>
                </div>
            </div>
